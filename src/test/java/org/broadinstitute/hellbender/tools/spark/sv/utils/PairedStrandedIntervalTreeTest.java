    ...
    public void testOverlappers() throws Exception {
        ...
        PairedStrandedIntervals v1 =
                new PairedStrandedIntervals(
                        new SVInterval(1, 100, 200),
                        true,
                        new SVInterval(1, 500, 600),
                        false);

        PairedStrandedIntervals v2 =
                new PairedStrandedIntervals(
                        new SVInterval(1, 10, 20),
                        false,
                        new SVInterval(1, 800, 900),
                        true);

        PairedStrandedIntervals v3 =
                new PairedStrandedIntervals(
                        new SVInterval(1, 205, 305),
                        true,
                        new SVInterval(1, 625, 725),
                        false);

        PairedStrandedIntervals query =
                new PairedStrandedIntervals(
                        new SVInterval(1, 110, 210),
                        true,
                        new SVInterval(1, 550, 650),
                        true);
        ...
        query.rightStrand = false;
        overlappers = psiTree.overlappers(query);
